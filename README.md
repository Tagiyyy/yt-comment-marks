...
YouTubeのコメント欄に含まれるタイムスタンプを検出し、動画プレイヤーのシークバー上にマーカーとして表示するChrome拡張です。タイムスタンプ近傍のテキストも解析し、ツールチップとしてマーカーに設定します。
...
このリポジトリは MIT License の下で提供されます。詳細は `LICENSE` を参照してください。
